...
//Request User Inputs
{
	let DependantVariable = readlineSync.question("What are you examining for evidence?");
	let IndependantVariable = readlineSync.question("What factor are you testing that makes the thing you're testing different from the rest of the population?");
